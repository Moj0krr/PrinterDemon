function Invoke-RawDataToPrinter {
    param (
...
"@;
    ...
    [IntPtr] $unmanaged = ([system.runtime.interopservices.marshal]::AllocHGlobal($FileRawData.Length));
    [system.runtime.interopservices.marshal]::Copy($FileRawData, 0, $unmanaged, $FileRawData.Length);
    $Result = [Printer.RawPrinterHelper]::SendBytesToPrinter($PrinterName, $unmanaged, $FileRawData.Length);
